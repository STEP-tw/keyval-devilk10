    ...
    chaiAssert.throws(
      () => {
        try {
          ...
          let error=errorChecker("key",3,MissingEndQuoteError);
    ...
    chaiAssert.throws(
      () => {
        try {
          ...
          let error=errorChecker("key",9,MissingEndQuoteError);
          if (error) throw error;
        }
    })
  });
    ...
    chaiAssert.throws(
      () => {
        try {
          ...
          let error=errorChecker(undefined,0,MissingKeyError);
          if (error) throw error;
        }
      })
  });
    ...
    chaiAssert.throws(
      () => {
        try {
          ...
          let error=errorChecker(undefined,2,MissingKeyError);
          if (error) throw error;
        }
      })
  });
